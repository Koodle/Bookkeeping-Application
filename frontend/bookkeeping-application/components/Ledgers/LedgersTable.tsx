export default function LedgersTable() {
  return (
    ...
    // <div className="fixed h-screen w-1/4 flex flex-col text-white shadow-lg bg-cyan-400">
    //   {/* <div className="pt-4 pb-4 text-center bg-black">Bookkeeper</div> */}
    //   <div className="pt-2 pb-2 text-center">Chart Of Accounts</div>
    //   <div>name, account number, balancebd</div>
    // </div>
